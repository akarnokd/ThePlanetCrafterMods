...
{
    [BepInPlugin("akarnokd.theplanetcraftermods.uitranslationpolish", "(UI) Polish Translation", "1.0.0.0")]
    public class Plugin : BaseUnityPlugin
    {
        const string languageKey = "polish";
        ...
        private void Awake()
        {
            ...
            string[] text = File.ReadAllLines(dir + "\\labels-pl.txt", Encoding.UTF8);
